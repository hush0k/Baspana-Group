...
import styles from '../../styles/FooterBlack.module.scss';
            ...
            <div className={styles.container}>
                ...
                <div className={styles.column}>
                    ...
                    <div className={styles.contacts}>
                        ...
                        <div className={styles.contactItem}>
                            ...
                            <a href="tel:+77757813549">+7 (775) 781-35-49</a>
                        </div>
                        ...
                        <div className={styles.contactItem}>
                            ...
                            <a href="mailto:info@baspanagroup.com">info@baspanagroup.com</a>
                        </div>
                    </div>
                </div>
                ...
                <div className={styles.column}>
                    ...
                    <div className={styles.socials}>
                        ...
                        <a href="https://wa.me/74951234567" target="_blank" rel="noopener noreferrer" className={styles.socialLink}>
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
