...
from app.models import Apartment, ApartmentType, CommercialUnit, Direction, Favorites, FinishingType, ObjectType, \
	PropertyStatus
...
def get_favorites_filtered(
	...
	for fav in favorites:
		if fav.object_type == ObjectType.apartment:
			...
			com_query = db.query(CommercialUnit).filter(CommercialUnit.id == fav.object_id)
