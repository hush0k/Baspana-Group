...
def create_residential_complex(
    db: Session, residential_complex: ResidentialComplexCreate
):
...
def update_residential_complex(
    db: Session, residential_id: int, complex_update: ResidentialComplexUpdate
):
    db_complex = (
        db.query(ResidentialComplex)
        .filter(ResidentialComplex.id == residential_id)
        .first()
    )
